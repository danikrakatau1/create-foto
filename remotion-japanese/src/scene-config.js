// FUJI V2 — composition + life-motion asset integration
// V1.3 remains untouched on main. Fuji stays the hero; motion is sparse and Japanese-cinematic.
export const sceneConfig = {
  durationSeconds: 10,
  motionLock: {cameraPush: 0.004, cameraX: 0, cameraY: -3, petalCount: 4},
  layers: [
    {id:'background',file:'background-main.jpg',x:540,y:960,width:1080,start:0,z:1,kind:'background'},
    {id:'fuji',file:'fuji-main.png',x:570,y:1110,width:1080,start:.20,z:2,enterY:24,motion:'fuji-still'},

    // Distant life: tiny crane silhouettes pass behind the mist, never becoming a focal subject.
    {id:'craneFar',file:'life-crane-illustration-cc0.svg',x:875,y:700,width:82,start:1.15,z:3,enterX:16,motion:'crane-flight'},

    // Layered mist: existing painted clouds + CC0 fog create real depth around Fuji's base.
    {id:'cloud1',file:'cloud-01.png',x:255,y:1035,width:560,start:.72,z:4,enterX:-18,motion:'cloud-right-soft'},
    {id:'fogLife',file:'life-fog-cc0.svg',x:545,y:1190,width:1180,start:1.02,z:4,enterX:-14,motion:'fog-drift'},
    {id:'cloud2',file:'cloud-02.png',x:865,y:1160,width:500,start:.92,z:4,enterX:18,motion:'cloud-left-soft'},
    ...
    {id:'pineRight',file:'pine-right.png',x:1025,y:1640,width:300,start:2,z:6,enterX:24,motion:'micro-sway-right',origin:'80% 96%'},
